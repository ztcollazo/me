...
const Project: FC<{ project: any }> = ({ project }) => (
  <Link passHref href={`/projects/${project.name}`}>
    <li style={{ transitionDuration: '.5s' }} className="rounded-xl cursor-pointer w-full md:w-[396px] md:flex-grow flex flex-col card justify-between dark:bg-gray-700 hover:translate-x-[1px] hover:translate-y-[-1px] transition-transform">
